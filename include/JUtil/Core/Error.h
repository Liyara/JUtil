...
#define ERROR_ERR_INDEX   0x07

#define JUTIL_ERR
#define JUTIL_INVOKE_ERR(a, b, c)           jutil::Error::write(a, b, c).handle();
#define JUTIL_ERR_MSG(a)                    a, __func__
...
#define ERR_INVOKE                  JUTIL_INVOKE_ERR((CORE_ERR_INDEX << 4) | ERROR_ERR_INDEX, ERR_INNER, JUTIL_ERR_MSG(ERR_MSG))
